//package io.app.arbittrading.serviceEqualsCurrencies.comparisonOfThreeExchanges;
//
...
//@Component
//@AllArgsConstructor
//public class CompareThreeExchanges {
...
//            if (binanceData.containsKey(currency) && currencyData.containsKey(currency)) {
